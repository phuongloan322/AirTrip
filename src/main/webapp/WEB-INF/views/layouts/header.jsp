...
<%-- <script src="<c:url value="/asset/js/jquery.js" />"></script> --%>
<script src="<c:url value="/asset/js/jquery-migrate-1.2.1.js" />"></script>
<script src="<c:url value="/asset/js/script.js" />"></script>
<script src="<c:url value="/asset/js/superfish.js" />"></script>
<script src="<c:url value="/asset/js/jquery.ui.totop.js" />"></script>
<script src="<c:url value="/asset/js/jquery.equalheights.js" />"></script>
<script src="<c:url value="/asset/js/jquery.mobilemenu.js" />"></script>
