...
public class Placedao {
	...
	public List<Placebean> getAllPlace() throws Exception {
		...
		String sql = "SELECT * FROM Place WHERE isEmpty = 1";
	...
	public List<Placebean> getPlaceByPaging(int PageNumber, int PageSize) throws Exception {
		...
		dc.KetNoi();
		String sql = "{CALL proc_PagingPlaceUser(?,?)}";
	...
	public List<Placebean> getPlaceByCategory(String categoryId) throws Exception {
		List<Placebean> placeList = new ArrayList<Placebean>();
		String sql = "SELECT * FROM Place as p join LitleCategory as l on p.litleCategoryId = l.litleCategoryId\r\n" + 
